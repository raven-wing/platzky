...
2. Create an application with `platzky create` (it comes with sample content), or copy `config-template.yml` to your project directory and fill it with your data.
